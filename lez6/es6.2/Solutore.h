...
class Solutore {
    ...
    virtual double Cercazerireference (double xmin, double xmax, const Funzionebase& f, double prec=0.001, unsigned int nmax=100)=0;
...
class Bisezione: public Solutore {
    ...
    virtual double Cercazerireference( double xmin, double xmax, const Funzionebase& f, double prec=0.001, unsigned int nmax=100) override;
};
