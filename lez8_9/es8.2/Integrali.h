...
class Integral {
    ...
    virtual double Integra(double campionamento, vector<double>& , const Funzionevettbase&, const Equazionedifferenzbase&)=0;
...
class Trapezi: public Integral {
    ...
    double Integra(double campionamento,  vector<double>& , const Funzionevettbase&, const Equazionedifferenzbase&);
};
